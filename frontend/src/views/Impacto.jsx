...
export default function Impacto({onOpenBitacora}){
  ...
  return <div className="damageView">
    ...
    <section className="damageKpiGrid">
      <Kpi icon={Trees} label="Superficie afectada registrada" value={`${Number(regions.reduce((a,r)=>a+(r.superficie||0),0)).toLocaleString("es-CL",{maximumFractionDigits:0})} ha`} sub="Temporada 2025/26" detail="Suma de la superficie registrada para incendios de la temporada." coverage="~77% con superficie informada" source="SIDCO · incendio.ince_superficie" confidence="Media-Alta"/>
