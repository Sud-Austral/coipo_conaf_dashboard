...
export default function Calidad(){
  return <div className="qualityViewV260">
    ...
    <section className="qualityKpis">{kpis.map(([l,v,s,I])=><article key={l}><div className="qualityKpiTitle"><I size={17}/><KpiInfo label={l} detail={s} source="SIDCO · análisis de cobertura"/></div><small>{l}</small><strong>{v}</strong><span>{s}</span></article>)}</section>
